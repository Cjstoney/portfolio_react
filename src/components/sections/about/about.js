...
const About = () => {
  ...
  const extraInfo = `${shortBio} I spent three years at The San Francisco Art Institute studying Fine Art with an emphasis in painting and photography.
  ...
  return (
    <div className="about-content">
      ...
      <Waves />
      <p className="bio ">{`${!!moreInfo ? extraInfo : shortBio}`}</p>
      <button className="learnMoreBtn" onClick={() => toggleInfo(!moreInfo)}>
