    ...
    return(
        ...
        <div  className="contact-container">
            <div className="icons">
                ...
                {/* </a> */}
            <a  href="https://www.linkedin.com/in/camerone-stoney-b8a798177/"><div className='contactBtn' >Check out my LinkedIn here</div></a>
            </div>
            <div className="icons">
                    <img id="github_icon" className="contact-icon" src="../images/GitHub-Mark-64px.png" alt="Github Icon" />
                <a  href="https://github.com/Cjstoney"> <div className='contactBtn'>See some of my code here</div>
                </a>
            </div>
            <div className="icons">
                    <img id="pdf_icon" className="contact-icon" src="../images/iconfinder_file-pdf_383140.png" alt="PDF portfolio Icon" />
                <a  href="assets/pdfs/document.pdf"><div className='contactBtn'>Take a look at my resume here</div>
                </a>
            </div>
        </div>
        </div>
